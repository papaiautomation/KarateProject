Feature: Karate Test Suite 10
  ...
  @soap
  Scenario: Karate SOAP API Read Data from External File TestCase 1
    Given url "https://www.w3schools.com/xml/tempconvert.asmx"
    And header Content-Type = "text/xml; charset=utf-8"
    #if it is in resources package, only file name is fine. Else ./ before the file name is also fine
